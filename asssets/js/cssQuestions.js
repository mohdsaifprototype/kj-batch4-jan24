const questions = [
  ...
  {
    question:
      "What is the correct syntax to select all <p> elements inside <div> elements?",
    options: ["div p", "div + p", "div > p", "p > div"],
    answer: "div p",
  },
  {
    question:
      "Which of the following is true about the CSS selector div.example?",
    options: [
  ...
  {
    question:
      "Identify the error in the CSS code: .class { color: blue; font-weight; bold; }",
    options: [
    ...
    answer: "Syntax error in property declaration",
  },
  {
    question:
